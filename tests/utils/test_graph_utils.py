...
class TestGraphUtils(TrainingPipelineTestCase):
    ...
    def test_operator_to_graph_isolated_vertex(self):
        """Test conversion between operator and graph with isolated vertices."""
    ...
    def test_operator_to_graph_single_z(self):
        """Test conversion between operator and graph with single-Z terms."""
    ...
    def test_circuit_to_graph_single_z(self):
        """Test that we can extract a graph from a QAOA cost op with a single-Z term."""
    ...
    def test_graph_to_operator_single_z(self):
        """Test the conversion of an unweighted graph to Pauli operator,
        where the input graph has a loop, which should produce a single-Z term"""
